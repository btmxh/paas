...
class TestExperiment(unittest.TestCase):
    def test_run_single_experiment_success(self):
        ...
        with patch("paas.hustack_main.Pipeline") as MockPipeline:
            ...
            with patch("paas.hustack_main.grade_schedule") as mock_grade:
                mock_grade.return_value = Score(num_tasks=1, makespan=10, total_cost=5)

                result = run_single_experiment(
                    mock_instance, MockPipeline, time_limit=1
                )
    ...
    def test_run_single_experiment_failure(self):
        ...
        with patch("paas.hustack_main.Pipeline") as MockPipeline:
            ...
            result = run_single_experiment(
                mock_instance, lambda: MockPipeline(), time_limit=1
            )
